...
public class OrdemServicoService {
    ...
    private OrdemServicoResponse montarResposta(OrdemServico os) {
        ...
        return new OrdemServicoResponse(
                ...
                os.getClienteRef() == null ? os.getCliente() : os.getClienteRef().getNomeCompleto(),
                os.getOficina() == null ? null : os.getOficina().getId(),
                os.getOficina() == null ? null : os.getOficina().getNome(),
                os.getStatus(),
                os.getDataAbertura(),
                os.getValorTotal(),
                pecas,
